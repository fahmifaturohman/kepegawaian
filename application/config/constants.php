...
#start my code
define('ID_INSTANSI', 1);
define('NAMA_INSTANSI', 'Pengadilan Tinggi Agama Bandar Lampung');
define('CURRENT_DITETAPKAN', 'Bandar Lampung');
define('LINK_GAMBAR', 'https://sikep.mahkamahagung.go.id/uploads/foto_pegawai/');
