                            ...
                            <div class="col-xl-12">
                                <form id = "form-update">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="id_pegawai" value="<?=$data->nama?>" class="form-control typeahead input-id-pegawai" id="input-cari-pegawai" placeholder="cari pegawai" autocomplete="off">
                                        <div class="text-danger"></div>
                                    </div>
                                    <div class="form-group">
